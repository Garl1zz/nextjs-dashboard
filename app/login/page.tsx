...
export default function Page() {
  ...
  const user = useUser()
  const team = user?.useTeam("09b45a29-e6b8-49ea-969b-28162e013b89")
  const hasAdminAccess = user?.usePermission(team!,'team_admin')
    ...
    <main className="flex min-h-screen bg-gradient-to-br from-red-400 via-red-500 to-yellow-500 relative overflow-hidden">
      ...
      <div className="flex max-w-6xl mx-auto z-10">
        ...
        <div className="w-full lg:w-1/2 flex items-center">
          <div className="bg-white shadow-2xl p-5 w-full max-w-lg min-h-[585px] max-h-[585px] backdrop-blur-sm bg-white/95">
            ...
            <form onSubmit={handleSignIn} className="space-y-6">
              ...
              {error && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                  <p className={`${alice.className} text-red-600 text-xs text-center`}>{error}</p>
                </div>
              )}
              ...
              <button
                type="submit"
                className={`w-full max-h-[500px] ${alice.className} bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold py-1 px-3 rounded-lg transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"`} 
              >
                Sign In
              </button>
               <div className={`${alice.className} text-center`}>
            ...
            {/* Footer */}
            <div className={`${alice.className} text-center mt-3`}>
              <p className="text-sm text-gray-600">
