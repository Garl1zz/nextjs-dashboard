...
export default function DetailProductPage() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: "Rp 20.000",
      stok: 5,
      description: "BeanBags Juggling Balls adalah pilihan ideal untuk para pesulap dan penggemar sirkus. Dengan desain yang ergonomis dan bahan berkualitas tinggi, bola ini memberikan kenyamanan dan kontrol yang luar biasa saat melakukan juggling. Cocok untuk semua tingkat keterampilan, BeanBags Juggling Balls akan meningkatkan performa Anda di atas panggung."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: "Rp 45.000",
      stok: 7,
      description: "Russian Juggling Balls adalah pilihan yang sempurna untuk para  pesulap dan penggemar sirkus. Dengan desain yang ergonomis dan bahan berkualitas tinggi, bola ini memberikan kenyamanan dan kontrol yang luar biasa saat melakukan juggling. Cocok untuk semua tingkat keterampilan, Russian Juggling Balls akan meningkatkan performa Anda di atas panggung."
    },
    {
      id: 5,
      ...
      price: "Rp 70.000",
      stok: 3,
      description: "Contact Juggling Balls adalah pilihan sempurna untuk para pesulap dan penggemar sirkus. Dengan desain yang ergonomis dan bahan berkualitas tinggi, bola ini memberikan kenyamanan dan kontrol yang luar biasa saat melakukan juggling. Cocok untuk semua tingkat keterampilan, Contact Juggling Balls akan meningkatkan performa Anda di atas panggung."
    },
    {
      id: 6,
      ...
      price: "Rp 150.000",
      stok: 2,
      description: "MMX Juggling Balls adalah pilihan sempurna untuk para pesul ap dan penggemar sirkus. Dengan desain yang ergonomis dan bahan berkualitas tinggi, bola ini memberikan kenyamanan dan kontrol yang luar biasa saat melakukan juggling. Cocok untuk semua tingkat keterampilan, MMX Juggling Balls akan meningkatkan performa Anda di atas panggung."
    },
    ...
    <div className="bg-white rounded-lg shadow-lg p-20 max-h- mx-auto" style={{ backgroundColor: '#981827' }}>
      ...
      {product ? (
        <div className="bg-white rounded-lg shadow-lg p-16 max-h- mx-auto" style={{ backgroundColor: 'lightgray' }}>
          ...
          <p className={`${alice.className} text-lg text-center text-black-500`}>Stok: {product.stok}</p>
          <p className={`${alice.className} mt-4 text-black-500 text-3x1`}>{product.description}</p>
        </div>
      ) : (
