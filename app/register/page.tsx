        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center mr-24 mb-12">
          ...
          <form className="space-y-4">
            <input
              ...
              className="w-full px-4 py-2 mb-2 bg-[#d5a153] text-black placeholder-black rounded-md border-2 border-black"
            />
            <input
              type="email"
              placeholder="Email"
              className="w-full px-4 py-2 bg-[#d5a153] text-black placeholder-black rounded-md border-2 border-black"
            />
            <div className="relative">
              <input
                type={showPassword ? "text" : "password"}
                placeholder="Password"
                className="w-full px-4 py-2 mt-2 mb-2 bg-[#d5a153] text-black placeholder-black rounded-md border-2 border-black"
              />
              <button
                type="button"
